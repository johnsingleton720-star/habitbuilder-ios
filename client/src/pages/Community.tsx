...
export default function Community() {
  usePageTitle("Community Forum", "Join the HabitBuilder.pro community. Share progress, find accountability partners, get tips and motivation from fellow habit builders.");
