...
export function TermsOfServiceGate() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm p-4" data-testid="tos-gate-overlay">
      <Card className="w-full max-w-md border-primary/30 shadow-lg" data-testid="card-tos-gate">
        <CardContent className="p-6 space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <h3 className="text-base font-semibold" data-testid="text-tos-title">Welcome to HabitBuilder</h3>
