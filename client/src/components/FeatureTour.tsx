...
const ALL_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    title: "Mood Check-in",
    description: "Log how you're feeling each day — your energy, stress, and mood. The AI uses this data to spot patterns and adjust your coaching, so your habits work with your real life, not against it.",
    icon: <Heart className="w-5 h-5 text-rose-500" />,
    position: "top",
  },
  {
  ...
  },
  {
    ...
    title: "Daily Planner",
    description: "The AI Planner looks at all your habits, commitments, and schedule and maps out an optimised daily plan for you — so you always know what to do and when, without having to think about it.",
